        ...
        child: Scaffold(
            ...
            children: [
              const Padding(
                ...
                child: Text('Where your interests connect you with your people',textScaleFactor: 1.7,textAlign: TextAlign.center,
              ...
              CarouselSlider(items: [
                CarouselItemBuilder(width: _width, height: _height,
                ...
                CarouselItemBuilder(width: _width, height: _height,
                  ...
                  poster: 'Posted by bleedgfx',gifView: true,),
                CarouselItemBuilder(width: _width, height: _height,
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                        ...
                        child: Center(child: Image.asset('assets/images/logo.png',width: (_width/2)-10,)))
                  ),
                          ...
                          child: Stack(
                            ...
                            children: [
                              AnimatedPositioned(
                                ...
                                left: 0,
                                right: 0,
                                bottom: (_currentButtonSet==1)?_height/6:_height/3,
                                    ...
                                    Row(
                                      children: [
                                        Expanded(child: Padding(
                                          padding: EdgeInsets.symmetric(horizontal: _width/7, vertical: 2),
                                          child: ElevatedButton(onPressed: (){
                                            setState(() {
                                              isClicked=true;
                                              _currentButtonSet=2; //signUp options
                                            });
                                          }, child: const Text('Sign up',textScaleFactor: 1.3,),
                              ...
                              AnimatedPositioned(
                                ...
                                left: 0,
                                right: 0,
                                bottom:( _currentButtonSet==2)?_height/6:0,
                                child: AnimatedOpacity(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(child: Padding(
                                          ...
                                          }, child: const Text('Sign up with email',textScaleFactor: 1.3,),
                                              style:onStartButtonStyle),
                                        )),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Expanded(child: Padding(
                                          padding: EdgeInsets.symmetric(horizontal: _width/7, vertical: 2),
                                          child: ElevatedButton(onPressed: (){}, child: const Text('Sign up with Google',textScaleFactor: 1.3,),
                                              style:onStartButtonStyle),
                                        )),
                                      ],
                                    ),
                              ...
                              AnimatedPositioned(
                                ...
                                left: 0,
                                right: 0,
                                bottom:( _currentButtonSet==3)?_height/6:0,
                                child: AnimatedOpacity(
                                      ...
                                      Row(
                                        children: [
                                          Expanded(child: Padding(
                                            ...
                                            child: const Text('Log in with email',textScaleFactor: 1.3,),
                                            style: onStartButtonStyle,
                                            ),
                                          )),
                                        ],
                                        ...
                                        children: [
                                          Expanded(child: Padding(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: (){},
                                              child: const Text('Log in with Google',textScaleFactor: 1.3,),
                                              style: onStartButtonStyle,
                                            ),
                                          )),
                                        ],
            ...
            Container(
              ...
              child: Center(
                child: AnimatedContainer(duration: const Duration(seconds: 1),
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular((_currentPage==page)?10:1.0),
                      color: Colors.white
                  ),
                ),
              ),
...
class CarouselItemBuilder extends StatelessWidget {
  ...
  const CarouselItemBuilder({
    ...
    bool gifView=false
  }) : _width = width, _height = height, _imageUrl=imageUrl,_title=title,_poster=poster,_gifView=gifView, super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
        ...
        children: [
          !_gifView?
          Image.asset(_imageUrl, width: _width,height: _height,fit: BoxFit.fitHeight,):
          GifView.asset(_imageUrl, width: _width,height: _height,fit: BoxFit.fitHeight,frameRate: 8,),
          Container(
            width: _width,
            height: _height,
            color: Colors.black.withOpacity(0.49),
          ),
          Positioned(child: Text(_poster,
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(_title,textScaleFactor: 2.2,textAlign: TextAlign.center,
